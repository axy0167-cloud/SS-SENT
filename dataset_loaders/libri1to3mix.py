...
LIBRI3MIX_ROOT_PATH = '/home4/dataset/LibriMix/Libri3Mix'    #  '/mnt/data/libri_mix/Libri3Mix'
...
class Dataset(torch.utils.data.Dataset, abstract_dataset.Dataset):
    ...
    def __init__(self, **kwargs):
        ...
        if self.split == 'train-360':
            self.n_samples = int(len(self.available_filenames))
